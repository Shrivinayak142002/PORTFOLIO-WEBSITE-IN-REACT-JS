    ...
    <section id="experience">
      ...
      <div className="experience__programming">
        <h3>Programming Languages</h3>
          ...
          <RiCodeBoxLine size={30} className="experience__details-icons"/>
            <div>
            <h4>C</h4>
          ...
          <article className="experience__details">
            <SiCplusplus size={30} className="experience__details-icons"/>
            <div>
            <h4>C++</h4>
            <small className="text-light">Intermediate</small>
            </div>
        ...
        <div className="experience__frontend">
          ...
          <article className="experience__details">
            <FaUserCheck size={30} className="experience__details-icons"/>
            <div>
            <h4>UI/UX</h4>
            <small className="text-light">Intermediate</small>
            </div>
